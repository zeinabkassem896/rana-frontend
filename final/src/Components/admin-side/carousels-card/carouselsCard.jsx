...
const CarouselAdmin = ({ carousel, handleChangeObject, refresh }) => {
  const deleteCarousel = async (id) => {
    try {
      const response = await axios.delete(
        `http://localhost:4000/api/carousels/${carousel._id}`
      );
  ...
  return (
    <div className="carousel-admin-container">
      <div className="card" key={carousel._id}>
        ...
        <div className="card-content-carousel">
          <p className="card-title-carousel">{carousel.title}</p>
          <p className="card-subtitle-carousel">{carousel.subtitle}</p>
